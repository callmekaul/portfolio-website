...
export const WINDOW_META: Record<WindowId, WindowMeta> = {
  ...
  contact:    { title: 'Contact',     icon: '✉️',  defaultSize: { width: 520, height: 820 } },
  display:    { title: 'Display',    icon: '🎨', defaultSize: { width: 480, height: 520 } },
  music:      { title: 'Music',      icon: '🎵', defaultSize: { width: 520, height: 520 } },
};

export const WINDOW_DEFAULTS: Record<WindowId, WindowDefault> = {
  music:      { position: { x: 30,  y: 30  }, size: WINDOW_META.music.defaultSize },
  about:      { position: { x: 30,  y: 30  }, size: WINDOW_META.about.defaultSize },
  contact:    { position: { x: 670, y: 30  }, size: WINDOW_META.contact.defaultSize },
